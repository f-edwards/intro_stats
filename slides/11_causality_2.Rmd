...
## An experiment on voting 

Participants were randomly assigned to receive one of two messages in a postcard about voting in an upcoming election: 

## Condition 1 (control): Civic duty 
...
## Condition 2 (treatment): Hawthorne effect (surveillance) 
...
- This condition -- statistically identical treatment and control groups -- is a necessary condition for counterfactual causal inference. 
