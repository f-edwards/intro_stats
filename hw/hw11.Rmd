...
```{r}
cor(log(yu$wage), yu$experience, use = "complete.obs")
```
...
Add `numChildren` as a predictor of `logwage` in your model. What is the estimated coefficient on the variable `numChildren`? Provide a brief substantive interpretation of the 
coefficient.
